...
class SVDSCommonTests:
    ...
    def test_svd_maxiter(self):
        ...
        A = np.diag(np.arange(9)).astype(float64)
        k = 1
    ...
    # ARPACK supports only dtype float, complex, or float32
    @pytest.mark.parametrize("dtype", (float, complex, float32))
    ...
    def test_small_sigma2(self, dtype):
        ...
        # Tolerances atol and rtol adjusted to pass float32
        # Use non-sparse svd
        u, s, vh = svd(mat)
