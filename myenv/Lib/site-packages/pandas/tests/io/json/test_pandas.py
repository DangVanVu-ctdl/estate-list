...
class TestPandasContainer:
    ...
    def datetime_series(self):
        ...
        ser = Series(
            1.1 * np.arange(10, dtype=float64),
    ...
    @pytest.mark.parametrize("dtype", [None, float64, int, "U3"])
    @pytest.mark.parametrize("convert_axes", [True, False])
    ...
    @pytest.mark.parametrize("dtype", [float64, int])
