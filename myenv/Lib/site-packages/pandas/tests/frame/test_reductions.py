...
class TestEmptyDataFrameReductions:
    ...
    @pytest.mark.parametrize(
        ...
        [
            ("sum", np.int8, float64),
            ("prod", np.int8, float64),
            ("sum", np.int64, float64),
            ("prod", np.int64, float64),
            ("sum", np.uint8, float64),
            ("prod", np.uint8, float64),
            ("sum", np.uint64, float64),
            ("prod", np.uint64, float64),
            ("sum", float32, float32),
...
def test_reduction_axis_none_returns_scalar(method, numeric_only, dtype):
    ...
    np_arr = df.to_numpy(dtype=float64)
