...
class TestFromRecords:
    ...
    def test_from_records_sequencelike(self):
        df = DataFrame(
            {
                "A": np.array(
                    np.random.default_rng(2).standard_normal(6), dtype=float64
                ),
                "A1": np.array(
                    np.random.default_rng(2).standard_normal(6), dtype=float64
                ),
                ...
                "E": np.array(
                    np.random.default_rng(2).standard_normal(6), dtype=float32
                ),
                "E1": np.array(
                    np.random.default_rng(2).standard_normal(6), dtype=float32
                ),
    ...
    def test_from_records_iterator(self):
        ...
        xp = DataFrame(
            {
                "x": np.array([1.0, 3.0], dtype=float64),
                "u": np.array([1.0, 3.0], dtype=float32),
