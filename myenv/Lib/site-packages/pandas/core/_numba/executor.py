...
float_dtype_mapping: dict[np.dtype, Any] = {
    np.dtype("int8"): float64,
    np.dtype("int16"): float64,
    np.dtype("int32"): float64,
    np.dtype("int64"): float64,
    np.dtype("uint8"): float64,
    np.dtype("uint16"): float64,
    np.dtype("uint32"): float64,
    np.dtype("uint64"): float64,
    np.dtype("float32"): float64,
    np.dtype("float64"): float64,
    np.dtype("complex64"): float64,
    np.dtype("complex128"): float64,
}
