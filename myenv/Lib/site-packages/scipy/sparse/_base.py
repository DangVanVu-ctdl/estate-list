...
class _spbase:
    ...
    def _divide(self, other, true_divide=False, rdivide=False):
        if isscalarlike(other):
            ...
            if true_divide and np.can_cast(self.dtype, float64):
                return self.astype(float64)._mul_scalar(1./other)
            else:
            ...
            self_csr = self.tocsr()
            if true_divide and np.can_cast(self.dtype, float64):
                return self_csr.astype(float64)._divide_sparse(other)
            else:
    ...
    def mean(self, axis=None, dtype=None, out=None):
        ...
        inter_dtype = float64 if integral else res_dtype
