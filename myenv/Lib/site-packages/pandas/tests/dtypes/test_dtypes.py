...
class TestCategoricalDtype(Base):
    ...
    def test_is_dtype(self, dtype):
        ...
        assert not CategoricalDtype.is_dtype(float64)
...
class TestDatetimeTZDtype(Base):
    ...
    def test_is_dtype(self, dtype):
        ...
        assert not DatetimeTZDtype.is_dtype(float64)
...
class TestPeriodDtype(Base):
    ...
    def test_is_dtype(self, dtype):
        ...
        assert not PeriodDtype.is_dtype(float64)
...
class TestIntervalDtype(Base):
    ...
    def test_closed_must_match(self):
        # GH#37933
        dtype = IntervalDtype(float64, "left")
    ...
    def test_is_dtype(self, dtype):
        ...
        assert not IntervalDtype.is_dtype(float64)
    ...
    def test_basic_dtype(self):
        ...
        with tm.assert_produces_warning(DeprecationWarning, match=msg):
            ...
            assert not is_interval_dtype(float64)
