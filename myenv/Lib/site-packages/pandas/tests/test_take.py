...
@pytest.fixture(
    params=[
        ...
        (np.int32, 1, np.int32),
        (np.int32, 2.0, float64),
        (np.int32, 3.0 + 4.0j, np.complex128),
        (np.int32, True, np.object_),
        (np.int32, "", np.object_),
        (float64, 1, float64),
        (float64, 2.0, float64),
        (float64, 3.0 + 4.0j, np.complex128),
        (float64, True, np.object_),
        (float64, "", np.object_),
...
class TestTake:
    ...
    def test_1d_other_dtypes(self):
        arr = np.random.default_rng(2).standard_normal(10).astype(float32)
    ...
    def test_2d_other_dtypes(self):
        arr = np.random.default_rng(2).standard_normal((10, 5)).astype(float32)
    ...
    def test_2d_float32(self):
        arr = np.random.default_rng(2).standard_normal((4, 3)).astype(float32)
        indexer = [0, 2, -1, 1, -1]
