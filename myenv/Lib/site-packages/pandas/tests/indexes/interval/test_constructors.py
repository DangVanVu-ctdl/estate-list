...
class ConstructorTests:
    ...
    @pytest.fixture(
        params=[
            ...
            (Index(np.arange(20, 30, 0.5), dtype=float64), float64),
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (Index([0, 1, 2, 3, 4], dtype=float64), "int64"),
...
class TestFromArrays(ConstructorTests):
    ...
    @pytest.mark.parametrize(
        "left_subtype, right_subtype", [(np.int64, float64), (float64, np.int64)]
    )
    def test_mixed_float_int(self, left_subtype, right_subtype):
        ...
        expected_left = Index(left, dtype=float64)
        expected_right = Index(right, dtype=float64)
        expected_subtype = float64
