...
DecMapType = dict[
    tuple[Callable[..., np.ndarray], Union[type[floating], type[int]], int],
    int,
]
...
@pytest.mark.parametrize('rdt', [np.longdouble, float64, float32, int])
