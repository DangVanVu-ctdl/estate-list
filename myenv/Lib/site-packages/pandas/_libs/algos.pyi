...
def nancorr(
    mat: npt.NDArray[float64],  # const float64_t[:, :]
    cov: bool = ...,
    minp: int | None = ...,
) -> npt.NDArray[float64]: ...  # ndarray[float64_t, ndim=2]
def nancorr_spearman(
    mat: npt.NDArray[float64],  # ndarray[float64_t, ndim=2]
    minp: int = ...,
) -> npt.NDArray[float64]: ...  # ndarray[float64_t, ndim=2]
...
def ensure_float64(arr: object) -> npt.NDArray[float64]: ...
