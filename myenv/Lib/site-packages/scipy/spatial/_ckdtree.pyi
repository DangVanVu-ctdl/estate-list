...
_BoxType = TypeVar("_BoxType", None, npt.NDArray[float64])
...
class cKDTreeNode:
    @property
    def data_points(self) -> npt.NDArray[float64]: ...
    @property
...
class cKDTree(Generic[_BoxType]):
    ...
    # These are read-only attributes in cython, which behave like properties
    @property
    def data(self) -> npt.NDArray[float64]: ...
    @property
    def maxes(self) -> npt.NDArray[float64]: ...
    @property
    def mins(self) -> npt.NDArray[float64]: ...
    @property
    def indices(self) -> npt.NDArray[float64]: ...
    @property
