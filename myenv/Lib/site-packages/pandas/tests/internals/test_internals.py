...
class TestBlockManager:
    ...
    def test_set_change_dtype(self, mgr):
        ...
        assert mgr2.iget(idx).dtype == float64
    ...
    def test_sparse(self):
        ...
        assert mgr.as_array().dtype == float64
    ...
    @pytest.mark.parametrize(
        "mgr_string, dtype",
        [("c: f4; d: f2", float32), ("c: f4; d: f2; e: f8", float64)],
    )
    ...
    def test_convert(self, using_infer_string):
        ...
        assert new_mgr.iget(4).dtype == float64
        ...
        assert new_mgr.iget(7).dtype == float64
        assert new_mgr.iget(8).dtype == float16
