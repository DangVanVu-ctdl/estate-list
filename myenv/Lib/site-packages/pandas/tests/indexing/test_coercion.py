...
class TestSetitemCoercion(CoercionBase):
    ...
    def _assert_setitem_index_conversion(
        ...
        # GH#33469 pre-2.0 with int loc_key and temp.index.dtype == float64
    ...
    @pytest.mark.parametrize(
        "val,exp_dtype", [(5, np.int64), (1.1, float64), ("x", object)]
    )
    ...
    @pytest.mark.parametrize(
        "val,exp_dtype", [(5, float64), (5.1, float64), ("x", object)]
    )
    def test_setitem_index_float64(self, val, exp_dtype, request):
        obj = pd.Series([1, 2, 3, 4], index=[1.1, 2.1, 3.1, 4.1])
        assert obj.index.dtype == float64
...
class TestWhereCoercion(CoercionBase):
    ...
    @pytest.mark.parametrize(
        "fill_val,exp_dtype",
        [(1, np.int64), (1.1, float64), (1 + 1j, np.complex128), (True, object)],
    )
    ...
    @pytest.mark.parametrize(
        "fill_val, exp_dtype",
        [(1, float64), (1.1, float64), (1 + 1j, np.complex128), (True, object)],
    )
