...
class TestSFloat:
    ...
    def test_scaled_float_from_floats(self, scaling):
        ...
        assert_array_equal(scaling * a.view(float64), [1., 2., 3.])
    ...
    def test_sfloat_casts(self, aligned):
        ...
        na = a.astype(SF(-1.))
        assert_array_equal(-1 * na.view(float64), a.view(float64))

        assert np.can_cast(a, SF(2.), casting="same_kind")
        assert not np.can_cast(a, SF(2.), casting="safe")
        a2 = a.astype(SF(2.))
        assert_array_equal(2 * a2.view(float64), a.view(float64))
    ...
    def test_sfloat_promotion(self):
        ...
        assert np.result_type(SF(3.), float64) == SF(3.)
        assert np.result_type(float64, SF(0.5)) == SF(1.)
    ...
    def test_basic_multiply(self):
        ...
        expected_view = a.view(float64) * b.view(float64)
        assert_array_equal(res.view(float64), expected_view)
    ...
    def test_possible_and_impossible_reduce(self):
        ...
        assert res == a.astype(float64).sum()
    ...
    def test_basic_ufunc_at(self):
        ...
        float_b = b.view(float64).copy()
        np.multiply.at(float_b, [1, 1, 1], float_a)
        np.multiply.at(b, [1, 1, 1], float_a)

        assert_array_equal(b.view(float64), float_b)
    ...
    def test_basic_multiply_promotion(self):
        ...
        expected_view = float_a * b.view(float64)
        assert_array_equal(res1.view(float64), expected_view)
        assert_array_equal(res2.view(float64), expected_view)
    ...
    def test_basic_addition(self):
        ...
        expected_view = (a.astype(res.dtype).view(float64) +
                         b.astype(res.dtype).view(float64))
        assert_array_equal(res.view(float64), expected_view)
    ...
    def test_wrapped_and_wrapped_reductions(self):
        ...
        assert res.view(float64) * 2 == expected
    ...
    def test_astype_class(self):
        ...
        assert_array_equal(res.view(float64), expected.view(float64))
    ...
    def test_creation_class(self):
        ...
        assert_array_equal(arr1.view(float64), arr2.view(float64))
    ...
    def test_np_save_load(self):
        ...
        with np.load(f.name, allow_pickle=True) as data:
            larr = data["arr_0"]
        assert_array_equal(arr.view(float64), larr.view(float64))
    ...
    def test_flatiter_index(self, index):
        ...
        np.testing.assert_array_equal(
            arr[index].view(float64), arr.flat[index].view(float64))

        arr2 = arr.copy()
        arr[index] = 5.0
        arr2.flat[index] = 5.0
        np.testing.assert_array_equal(
            arr.view(float64), arr2.view(float64))
