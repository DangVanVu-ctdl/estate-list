...
class TestDataFramePlots:
    ...
    @pytest.mark.parametrize("index_dtype", [np.int64, float64])
    ...
    def test_line_area_nan_df(self, idx):
        ...
        exp = np.array([1, 2, 3], dtype=float64)
        tm.assert_numpy_array_equal(np.delete(masked1.data, 2), exp)

        exp = np.array([3, 2, 1], dtype=float64)
    ...
    def test_line_area_nan_df_stacked(self, idx):
        ...
        expected1 = np.array([1, 2, 0, 3], dtype=float64)
        expected2 = np.array([3, 0, 2, 1], dtype=float64)
