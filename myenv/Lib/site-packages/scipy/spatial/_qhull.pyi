...
class _Qhull:
    ...
    def __init__(
        ...
        furthest_site: bool = ...,
        incremental: bool = ...,
        interior_point: None | NDArray[float64] = ...,
    ) -> None: ...
    def check_active(self) -> None: ...
    def close(self) -> None: ...
    def get_points(self) -> NDArray[float64]: ...
    def add_points(
        self,
        points: ArrayLike,
    ...
    def get_hull_points(self) -> NDArray[float64]: ...
...
class Delaunay(_QhullUser):
    ...
    def plane_distance(self, xi: ArrayLike) -> NDArray[float64]: ...
    def lift_points(self, x: ArrayLike) -> NDArray[float64]: ...
...
class HalfspaceIntersection(_QhullUser):
    interior_point: NDArray[float64]
    dual_facets: list[list[int]]
    dual_equations: NDArray[float64]
    dual_points: NDArray[float64]
    dual_volume: float
    dual_area: float
    intersections: NDArray[float64]
    ndim: int
    nineq: int
    ...
    @property
    def halfspaces(self) -> NDArray[float64]: ...
    @property
