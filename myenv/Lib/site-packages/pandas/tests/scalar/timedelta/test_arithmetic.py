...
class TestTimedeltaAdditionSubtraction:
    ...
    def test_td_add_sub_numeric_raises(self):
        ...
        for other in [2, 2.0, np.int64(2), float64(2)]:
...
class TestTimedeltaMultiplicationDivision:
    ...
    @pytest.mark.parametrize("nan", [np.nan, float64("NaN"), float("nan")])
    @pytest.mark.parametrize("op", [operator.mul, ops.rmul])
    def test_td_mul_nan(self, op, nan):
        # float64('NaN') has a 'dtype' attr, avoid treating as array
        td = Timedelta(10, unit="d")
        result = op(td, nan)
        assert result is NaT
    ...
    def test_td_rdiv_ndarray(self):
        ...
        result = arr / td
        expected = np.array([1], dtype=float64)
        tm.assert_numpy_array_equal(result, expected)
        ...
        arr = np.array([np.nan], dtype=float64)
    ...
    def test_td_floordiv_numeric_scalar(self):
        ...
        assert td // float64(2.0) == expected
    ...
    def test_td_rfloordiv_numeric_scalar(self):
        ...
        assert td.__rfloordiv__(float64(2.0)) is NotImplemented
