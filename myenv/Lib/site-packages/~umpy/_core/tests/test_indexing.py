...
class TestIndexing:
    ...
    def test_array_like_values(self):
        ...
        a = np.zeros((5, 5))
        s = np.arange(25, dtype=float64).reshape(5, 5)
    ...
    def test_scalar_return_type(self):
        ...
        a = np.zeros(())
        assert_(isinstance(a[()], float64))
        a = np.zeros(1)
        assert_(isinstance(a[z], float64))
        a = np.zeros((1, 1))
        assert_(isinstance(a[z, np.array(0)], float64))
        assert_(isinstance(a[z, ArrayLike()], float64))
...
class TestFloatNonIntegerArgument:
    ...
    def test_non_integer_argument_errors(self):
        ...
        assert_raises(TypeError, np.take, a, [0], float64(1.))
    ...
    def test_non_integer_sequence_multiplication(self):
        ...
        assert_raises(TypeError, mult, [1], float64(3))
