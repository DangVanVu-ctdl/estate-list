...
def find_repeats(arr):
    ...
    compr = np.asarray(ma.compressed(arr), dtype=float64)
    try:
...
def moment(a, moment=1, axis=0):
    ...
    if a.size == 0:
        ...
        dtype = a.dtype.type if a.dtype.kind in 'fc' else float64
...
def describe(a, axis=0, ddof=0, bias=True):
    ...
    DescribeResult(nobs=np.int64(3), minmax=(masked_array(data=0,
           ...
           fill_value=999999), masked_array(data=2,
                 mask=False,
           fill_value=999999)), mean=float64(1.0),
           variance=float64(0.6666666666666666),
           skewness=masked_array(data=0., mask=False, fill_value=1e+20),
            kurtosis=float64(-1.5))
