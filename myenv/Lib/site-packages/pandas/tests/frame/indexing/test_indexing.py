...
class TestDataFrameIndexing:
    ...
    def test_setitem_cast(self, float_frame):
        ...
        float_frame["foo"] = "bar"
        float_frame["foo"] = 2.5
        assert float_frame["foo"].dtype == float64
        ...
        assert float_frame["something"].dtype == float64
    ...
    def test_iloc_setitem_enlarge_no_warning(self, warn_copy_on_write):
        ...
        expected = df.copy()
        view = df[:]
        df.iloc[:, 0] = np.array([1, 2], dtype=float64)
...
class TestSetitemValidation:
    ...
    @pytest.mark.parametrize(
        "invalid", _invalid_scalars + [1, 1.0, np.int64(1), float64(1)]
    )
    ...
    @pytest.mark.parametrize("invalid", _invalid_scalars + [True, 1.5, float64(1.5)])
    @pytest.mark.parametrize("indexer", _indexers)
