...
def test_is_hashable():
    ...
    hashable = (1, 3.14, float64(3.14), "a", (), (1,), HashableClass())
...
class TestInference:
    ...
    def test_maybe_convert_numeric_post_floatify_nan(
        ...
        expected = np.array([1.2, np.nan, 4.5], dtype=float64)
...
class TestTypeInference:
    ...
    def test_floats(self):
        arr = np.array([1.0, 2.0, 3.0, float64(4), float32(5)], dtype="O")
        result = lib.infer_dtype(arr, skipna=True)
        assert result == "floating"

        arr = np.array([1, 2, 3, float64(4), float32(5), "foo"], dtype="O")
        result = lib.infer_dtype(arr, skipna=True)
        assert result == "mixed-integer"
...
class TestNumberScalar:
    ...
    def test_is_bool(self):
        ...
        assert not is_bool(float64(1.1))
    ...
    def test_is_integer(self):
        ...
        assert not is_integer(float64(1.1))
    ...
    def test_is_timedelta(self):
        ...
        assert not is_timedelta64_ns_dtype(Index([], dtype=float64))
