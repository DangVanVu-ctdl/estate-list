...
class TestScalars:
    ...
    def test_float32(self):
        ...
        assert_identical(s.f32, float32(-3.1234567e+37))

    def test_float64(self):
        s = readsav(path.join(DATA_PATH, 'scalar_float64.sav'), verbose=False)
        assert_identical(s.f64, float64(-1.1976931348623157e+307))
...
class TestCompressed(TestScalars):
    ...
    def test_compressed(self):
        ...
        assert_identical(s.arrays.b[0], np.array([4., 5., 6., 7.], dtype=float32))
...
class TestStructures:
    ...
    def test_scalars(self):
        ...
        assert_identical(s.scalars.c, np.array(float32(3.)))
        assert_identical(s.scalars.d, np.array(float64(4.)))
    ...
    def test_scalars_replicated(self):
        ...
        assert_identical(s.scalars_rep.c, np.repeat(float32(3.), 5))
        assert_identical(s.scalars_rep.d, np.repeat(float64(4.), 5))
    ...
    def test_scalars_replicated_3d(self):
        ...
        assert_identical(s.scalars_rep.c,
                         np.repeat(float32(3.), 24).reshape(4, 3, 2))
        assert_identical(s.scalars_rep.d,
                         np.repeat(float64(4.), 24).reshape(4, 3, 2))
    ...
    def test_arrays(self):
        ...
        assert_array_identical(s.arrays.b[0],
                               np.array([4., 5., 6., 7.], dtype=float32))
...
class TestPointerArray:
    ...
    def test_3d(self):
        ...
        assert_equal(s.array3d.shape, (11, 22, 12))
        assert_(np.all(s.array3d == float32(4.)))
    ...
    def test_4d(self):
        ...
        assert_equal(s.array4d.shape, (4, 5, 8, 7))
        assert_(np.all(s.array4d == float32(4.)))
    ...
    def test_5d(self):
        ...
        assert_equal(s.array5d.shape, (4, 3, 4, 6, 5))
        assert_(np.all(s.array5d == float32(4.)))
    ...
    def test_6d(self):
        ...
        assert_equal(s.array6d.shape, (3, 6, 4, 5, 3, 4))
        assert_(np.all(s.array6d == float32(4.)))
    ...
    def test_7d(self):
        ...
        assert_equal(s.array7d.shape, (2, 1, 2, 3, 4, 3, 2))
        assert_(np.all(s.array7d == float32(4.)))
    ...
    def test_8d(self):
        ...
        assert_equal(s.array8d.shape, (4, 3, 2, 1, 2, 3, 5, 4))
        assert_(np.all(s.array8d == float32(4.)))
...
class TestPointerStructures:
    ...
    def test_scalars(self):
        ...
        assert_identical(s.pointers.g, np.array(float32(4.), dtype=np.object_))
        assert_identical(s.pointers.h, np.array(float32(4.), dtype=np.object_))
    ...
    def test_pointers_replicated(self):
        ...
        assert_identical(s.pointers_rep.g,
                         np.repeat(float32(4.), 5).astype(np.object_))
    ...
    def test_pointers_replicated_3d(self):
        s = readsav(path.join(DATA_PATH, 'struct_pointers_replicated_3d.sav'),
                    verbose=False)
        s_expect = np.repeat(float32(4.), 24).reshape(4, 3, 2).astype(np.object_)
    ...
    def test_arrays(self):
        ...
        assert_array_identical(s.arrays.g[0],
                               np.repeat(float32(4.), 2).astype(np.object_))
        assert_array_identical(s.arrays.h[0],
                               np.repeat(float32(4.), 3).astype(np.object_))
