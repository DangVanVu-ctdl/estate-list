...
class TestDataFrameConstructors:
    ...
    def test_constructor_cast_failure(self):
        ...
        with pytest.raises(ValueError, match=msg):
            DataFrame({"a": ["a", "b", "c"]}, dtype=float64)
    ...
    def test_constructor_maskedarray_nonfloat(self):
        ...
        # cast type
        frame = DataFrame(mat, columns=["A", "B", "C"], index=[1, 2], dtype=float64)
        assert frame.values.dtype == float64
    ...
    def test_constructor_more(self, float_frame):
        ...
        # int cast
        dm = DataFrame(
            {"A": np.ones(10, dtype=int), "B": np.ones(10, dtype=float64)},
            index=np.arange(10),
        )

        assert len(dm.columns) == 2
        assert dm.values.dtype == float64
    ...
    def test_constructor_with_datetimes(self, using_infer_string):
        ...
        floatname = np.dtype(float64).name
