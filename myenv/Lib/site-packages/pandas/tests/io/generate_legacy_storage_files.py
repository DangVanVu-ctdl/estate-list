...
def _create_sp_series():
    ...
    # nan-based
    arr = np.arange(15, dtype=float64)
    arr[7:12] = nan
    arr[-1:] = nan
...
def create_pickle_data():
    ...
    index = {
        ...
        "float": Index(np.arange(10, dtype=float64)),
    ...
    series = {
        ...
        "dup": Series(np.arange(5).astype(float64), index=["A", "B", "C", "D", "A"]),
    ...
    frame = {
        ...
        "mi": DataFrame(
            {"A": np.arange(5).astype(float64), "B": np.arange(5).astype(np.int64)},
            index=MultiIndex.from_tuples(
                tuple(
                    zip(
                        *[
        ...
        "dup": DataFrame(
            np.arange(15).reshape(5, 3).astype(float64), columns=["A", "B", "A"]
        ),
