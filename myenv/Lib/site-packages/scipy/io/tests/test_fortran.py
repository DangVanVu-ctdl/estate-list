...
def test_fortranfile_read_mixed_record():
    ...
    ax = np.arange(3*3).reshape(3, 3).astype(float64)
...
def test_fortranfile_write_mixed_record(tmpdir):
    ...
    r1 = (('f4', 'f4', 'i4'), (float32(2), float32(3), np.int32(100)))
    r2 = (('4f4', '(3,3)f4', '8i4'),
          (np.random.randint(255, size=[4]).astype(float32),
           np.random.randint(255, size=[3, 3]).astype(float32),
